    ...
    <body bgcolor="#DCDCDC">
        ...
        <nav class="navbar navbar-inverse" data-spy="affix" data-offset-top="200">
            ...
            <?php
                                    ...
                                    <div class='panel panel-default'>
                                        <div class='panel-body'>
                                            <div class='form-group'>
                                                <center><h4 style='color:blue;'><i class='fa fa-search'></i>&nbsp;&nbsp;Other Year</h4></center>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                $sqlYear="SELECT DISTINCT year FROM Article WHERE statusOff=0";
                //echo $sqlSelect;
                $objYear = $objConnect->query($sqlYear);
                $count=0;
                echo "<div class='container'>";
                while ($row = $objYear->fetch_object()) {
                    $count++;
                    ...
                    echo "  <div class='col-md-3 col-xs-6'>
                                <div class='panel panel-default'>
                                    <div class='panel-heading'>
                                        <div class='form-group'>
                                            <center><h4><b>".$row->year."</b></h4></center>
                                        </div>
                                    </div>
                                    <div class='panel-body'>
                                        <div class='form-group'>
                                            
                                            <ul role='menu' aria-labelledby='archive'>";

                                            $sqlcntM="SELECT * FROM Article WHERE statusOff=0 AND month=01 AND year='".$row->year."'";
                                            $objMonth = $objConnect->query($sqlcntM);
                                            if($objMonth->num_rows>0)echo "<a href='searchMonth.php?month=01&year=".$row->year."' style='text-decoration: none;'>January&nbsp;&nbsp;<span class='badge'>".$objMonth->num_rows."</span></a><br>";

                                            $sqlcntM="SELECT * FROM Article WHERE statusOff=0 AND month=02 AND year='".$row->year."'";
                                            $objMonth = $objConnect->query($sqlcntM);
                                            if($objMonth->num_rows>0)echo "<a href='searchMonth.php?month=02&year=".$row->year."' style='text-decoration: none;'>February&nbsp;&nbsp;<span class='badge'>".$objMonth->num_rows."</span></a><br>";

                                            $sqlcntM="SELECT * FROM Article WHERE statusOff=0 AND month=03 AND year='".$row->year."'";
                                            $objMonth = $objConnect->query($sqlcntM);
                                            if($objMonth->num_rows>0)echo "<a href='searchMonth.php?month=03&year=".$row->year."' style='text-decoration: none;'>March&nbsp;&nbsp;<span class='badge'>".$objMonth->num_rows."</span></a><br>";

                                            $sqlcntM="SELECT * FROM Article WHERE statusOff=0 AND month=04 AND year='".$row->year."'";
                                            $objMonth = $objConnect->query($sqlcntM);
                                            if($objMonth->num_rows>0)echo "<a href='searchMonth.php?month=04&year=".$row->year."' style='text-decoration: none;'>April&nbsp;&nbsp;<span class='badge'>".$objMonth->num_rows."</span></a><br>";

                                            $sqlcntM="SELECT * FROM Article WHERE statusOff=0 AND month=05 AND year='".$row->year."'";
                                            $objMonth = $objConnect->query($sqlcntM);
                                            if($objMonth->num_rows>0)echo "<a href='searchMonth.php?month=05&year=".$row->year."' style='text-decoration: none;'>May&nbsp;&nbsp;<span class='badge'>".$objMonth->num_rows."</span></a><br>";

                                            $sqlcntM="SELECT * FROM Article WHERE statusOff=0 AND month=06 AND year='".$row->year."'";
                                            $objMonth = $objConnect->query($sqlcntM);
                                            if($objMonth->num_rows>0)echo "<a href='searchMonth.php?month=06&year=".$row->year."' style='text-decoration: none;'>June&nbsp;&nbsp;<span class='badge'>".$objMonth->num_rows."</span></a><br>";

                                            $sqlcntM="SELECT * FROM Article WHERE statusOff=0 AND month=07 AND year='".$row->year."'";
                                            $objMonth = $objConnect->query($sqlcntM);
                                            if($objMonth->num_rows>0)echo "<a href='searchMonth.php?month=07&year=".$row->year."' style='text-decoration: none;'>July&nbsp;&nbsp;<span class='badge'>".$objMonth->num_rows."</span></a><br>";
                            
                                            $sqlcntM="SELECT * FROM Article WHERE statusOff=0 AND month=08 AND year='".$row->year."'";
                                            $objMonth = $objConnect->query($sqlcntM);
                                            if($objMonth->num_rows>0)echo "<a href='searchMonth.php?month=08&year=".$row->year."' style='text-decoration: none;'>August&nbsp;&nbsp;<span class='badge'>".$objMonth->num_rows."</span></a><br>";
                            
                                            $sqlcntM="SELECT * FROM Article WHERE statusOff=0 AND month=09 AND year='".$row->year."'";
                                            $objMonth = $objConnect->query($sqlcntM);
                                            if($objMonth->num_rows>0)echo "<a href='searchMonth.php?month=09&year=".$row->year."' style='text-decoration: none;'>September&nbsp;&nbsp;<span class='badge'>".$objMonth->num_rows."</span></a><br>";
                            
                                            $sqlcntM="SELECT * FROM Article WHERE statusOff=0 AND month=10 AND year='".$row->year."'";
                                            $objMonth = $objConnect->query($sqlcntM);
                                            if($objMonth->num_rows>0)echo "<a href='searchMonth.php?month=10&year=".$row->year."' style='text-decoration: none;'>October&nbsp;&nbsp;<span class='badge'>".$objMonth->num_rows."</span></a><br>";
                            
                                            $sqlcntM="SELECT * FROM Article WHERE statusOff=0 AND month=11 AND year='".$row->year."'";
                                            $objMonth = $objConnect->query($sqlcntM);
                                            if($objMonth->num_rows>0)echo "<a href='searchMonth.php?month=11&year=".$row->year."' style='text-decoration: none;'>November&nbsp;&nbsp;<span class='badge'>".$objMonth->num_rows."</span></a><br>";
                            
                                            $sqlcntM="SELECT * FROM Article WHERE statusOff=0 AND month=12 AND year='".$row->year."'";
                                            $objMonth = $objConnect->query($sqlcntM);
                                            if($objMonth->num_rows>0)echo "<a href='searchMonth.php?month=12&year=".$row->year."' style='text-decoration: none;'>December&nbsp;&nbsp;<span class='badge'>".$objMonth->num_rows."</span></a><br>";
