        ...
        <nav class="navbar navbar-inverse" data-spy="affix" data-offset-top="200">
            ...
            <?php
                if(isset($_GET['page']) && $_GET['page']>1){
                    $numOfRow = ($_GET['page'] * 5);
                    $numOfRowLimit = $numOfRow + 1 ;
                    $sqlSelect="SELECT * FROM Article WHERE statusOff=0 ORDER BY idArticle DESC LIMIT ".$numOfRowLimit;
                    //echo $sqlSelect;
                    $objArticle = $objConnect->query($sqlSelect);
                    //echo $objArticle->num_rows." rows";
                    $count=0;
                    ...
                    echo "  <div class='container'>
                                <div class='row'>
                                    ...
                                    <div class='col-md-4 col-xs-6'>
                                        <a href='index.php?page=".($_GET['page']-1)."'><button class='btn btn-default btn-md pull-right'><i class='fa fa-angle-double-left'></i>&nbsp;&nbsp;Previous</button></a>
                                    </div>
                                    <div class='col-md-4 col-xs-6'>";
                                        if($objArticle->num_rows > $numOfRow)echo "<a href='index.php?page=".($_GET['page']+1)."'><button class='btn btn-default btn-md pull-left'>&nbsp;&nbsp;&nbsp;&nbsp;Next&nbsp;&nbsp;<i class='fa fa-angle-double-right'></i>&nbsp;&nbsp;&nbsp;</button></a>";
                                    echo "</div>
                                    <div class='col-md-2 col-xs-0'></div>
                                </div>
                            </div>";
                    ...
                    $sqlSelect="SELECT * FROM Article WHERE statusOff=0 ORDER BY idArticle DESC LIMIT 6";
                    //echo $sqlSelect;
                    $objArticle = $objConnect->query($sqlSelect);
                    //echo $objArticle->num_rows." rows";
                    $count=0;
                    ...
                    if($objArticle->num_rows > 5){
                        echo "<div class='container'>
                                <div class='row'>
                                    ...
                                    <div class='col-md-4 col-xs-6'>
                                        <a href='index.php?page=2'><button class='btn btn-default btn-md pull-left'>&nbsp;&nbsp;&nbsp;&nbsp;Next&nbsp;&nbsp;<i class='fa fa-angle-double-right'></i>&nbsp;&nbsp;&nbsp;</button></a>
                                    </div>
                                    <div class='col-md-2 col-xs-0'></div>
                                </div>
                            </div>";
