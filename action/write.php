    ...
    <body bgcolor="#DCDCDC">
        ...
        <div class="container">
            <div class="row" style="margin-top: -30px;">
                ...
                <div class="col-sm-8">
                    <h2><i class="glyphicon glyphicon-pencil"></i>&nbsp;Write Blog</h2>
                    <form action="doWrite.php" method="post">
                        <div class="panel panel-default">
                            <!--Entry Header-->
                            <div class="panel-heading">
                                <div class="form-group">
                                    <input name="name" maxlength="100" class="form-control ng-pristine ng-empty ng-invalid ng-invalid-required ng-touched" type="text" data-ng-disabled="posted" data-ng-model="name" required="" placeholder="Blog name">
                                </div>
                            </div>
                            ...
                            <div class="panel-footer clearfix">
                                <input type="checkbox" name="statusOff">&nbsp;<i class="glyphicon glyphicon-eye-close"></i>&nbsp;Only me <font size="2px">(If you check this, Other people don't see your posted.)</font>
                                <button type="submit" class="btn btn-success btn-md pull-right"><i class="glyphicon glyphicon-pencil"></i>&nbsp;&nbsp;Write</button>
                            </div>
                        </div>
                    </form>
                </div>
